...
HD_PWD='/home/holmes/Bureau/VHDL/VHDL_Ethernet/ethernet/ethernet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_transmitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_transmitter.tcl
